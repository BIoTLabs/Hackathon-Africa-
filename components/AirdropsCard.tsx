...
export default function AirdropsCard({ airdrops }: Props) {
  return (
    ...
    <section className='md:px-20 px-5 pt-10 py-10 lg:py-24 flex sm:flex-col-reverse lg:flex-row flex-col lg:space-x-10 xxl:px-96 bg-[#FAFAFA]'>
      <div className='lg:w-6/12 w-full sm:mt-20 lg:mt-10 grid-cols-2 place-items-center grid md:grid-cols-2 lg:grid-cols-1 gap-x-3'>
        {airdrops.map((airdrop) => (
          <Link
            ...
            key={airdrop._id}
            className='p-1 border mb-3 rounded-lg shadow-sm bg-white border-gray-300 sm:w-fit md:w-full transform hover:scale-105 transition duration-300 hover:border-orange-300'
          >
            <div className='md:flex space-x-4 items-center'>
              ...
              <div className='flex flex-col'>
                ...
                <div className='flex flex-col sm:my-3 sm:mb-3'>
                  ...
                  {/* <div className='text-gray-500 font-bold mt-3 flex flex-start'>
                    <p className='text-[#FF761C] px-8 py-2 rounded-md'>
                      Claim Now
                    </p>
                  </div> */}
                </div>
      ...
      <div className='lg:w-6/12 w-full flex flex-col'>
        ...
        <p className='mt-4 text-base md:text-xl !leading-10 text-gray-500 lg:max-w-xl'>
